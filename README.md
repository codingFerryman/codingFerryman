...
I'm currently seeking a job! If there is anything I can contribute to your team or your work, feel free to reach out!

<details>
<summary>TL;DR</summary>
<p align="justify">I am a data-driven problem solver with 10 years of coding experience. </p>
<p align="justify">I started in 2014 with Java during my bachelor's study, making simple stock management tools and expanding my knowledge over time. Around 2015, I started to use Python to build machine learning models. I joined Morgan Stanley Investment Management China (former Morgan Stanley Huaxin Funds) in 2016 as a quantitative analyst intern to develop sentiment-driven factor using machine learning for quant trading. From 2017 to 2020, I worked as an individual quant trader.

Over the last few years, my knowledge and experience with data mining have expanded. In 2022, I joined Mobbot SA, a Swiss start-up (which has gone 😔), and built an intelligent anomaly detection system for the shotcrete in tunnelling. The system leveraged the unlabeled time-series data collected from 7+ sensors, extracted features, and detected anomalous spray patterns. The experience was fruitful and enjoyable!
